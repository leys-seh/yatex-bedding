...
export default function IletisimPage({ locale = defaultLocale }: { locale?: Locale }) {
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-5 sm:block sm:space-y-8">
            <div>
              <p className="mb-1 text-xs uppercase tracking-widest2 text-ink/50 sm:mb-2 font-body">
                {dictionary.contactPage.showroom}
              </p>
              <a
            ...
            <div>
              ...
              <p dir="ltr" className="break-words text-lg text-ink sm:text-xl font-display">
            ...
            <div>
              <p className="mb-1 text-xs uppercase tracking-widest2 text-ink/50 sm:mb-2 font-body">
                {dictionary.contactPage.hours}
              </p>
              <p className="break-words text-lg text-ink sm:text-xl font-display">
                <span className="block">{dictionary.contactPage.weekdays}</span>
                <span className="block">{dictionary.contactPage.saturday}</span>
                <span className="block">{dictionary.contactPage.sunday}</span>
              </p>
            </div>
          </div>
            ...
            <form className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder={dictionary.contactPage.namePlaceholder}
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="email"
                  className="w-full border-b border-gold-soft/40 bg-transparent py-2.5 text-ink transition-colors focus:border-gold-soft focus:outline-none sm:py-3 font-body"
                  placeholder={dictionary.contactPage.emailPlaceholder}
                />
              </div>
